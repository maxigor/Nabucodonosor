...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/max/.local/share/nvim/site/pack/packer/opt/Comment.nvim",
  ...
  LuaSnip = {
    ...
    loaded = false,
    needs_bufread = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/opt/LuaSnip",
  ...
  base46 = {
    ...
    loaded = true,
    only_config = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/base46",
  ...
  cmp_luasnip = {
    after = { "cmp-nvim-lua" },
    after_files = { "/home/max/.local/share/nvim/site/pack/packer/opt/cmp_luasnip/after/plugin/cmp_luasnip.lua" },
    load_after = {
      LuaSnip = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/home/max/.local/share/nvim/site/pack/packer/opt/cmp_luasnip",
  ...
  extensions = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/max/.local/share/nvim/site/pack/packer/opt/extensions",
  ...
  ["indent-blankline.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/max/.local/share/nvim/site/pack/packer/opt/indent-blankline.nvim",
  ...
  ["mason.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/max/.local/share/nvim/site/pack/packer/opt/mason.nvim",
  ...
  ["nvim-autopairs"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/max/.local/share/nvim/site/pack/packer/opt/nvim-autopairs",
  ...
  ["nvim-treesitter"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/max/.local/share/nvim/site/pack/packer/opt/nvim-treesitter",
  ...
  nvterm = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/max/.local/share/nvim/site/pack/packer/opt/nvterm",
  ...
  ["plenary.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/max/.local/share/nvim/site/pack/packer/opt/plenary.nvim",
  ...
  ui = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/max/.local/share/nvim/site/pack/packer/opt/ui",
