...
if [[ ! $DESKTOP_ENV == server ]]; then
	sed -n '/'$INSTALL_TYPE'/q;p' $HOME/nabucodonosor/pkg-files/pacman-pkgs.txt | while read line; do
...
if ! source $HOME/nabucodonosor/configs/setup.conf; then
	...
	echo "username=${username,,}" >>${HOME}/nabucodonosor/configs/setup.conf

	#Set Password
	read -p "Please enter password:" password
	echo "password=${password,,}" >>${HOME}/nabucodonosor/configs/setup.conf
	...
	echo "NAME_OF_MACHINE=${name_of_machine,,}" >>${HOME}/nabucodonosor/configs/setup.conf
fi
echo -ne "
-------------------------------------------------------------------------
                    Adding User
...
if [ $(whoami) = "root" ]; then
	...
	chown -R $USERNAME: /home/$USERNAME/nabucodonosor
	echo "nabucodonosor copied to home directory"
